 ...
 */
public class DialogFragmentEmailExportAddressEdit extends DialogFragment {

    private final String TAG = "LOGGING::" + this.getClass().getSimpleName();

    private EditText emailAddressText;

    public DialogFragmentEmailExportAddressEdit(){
    ...
    public static DialogFragmentEmailExportAddressEdit newInstance(String title, String currentAddress){
        DialogFragmentEmailExportAddressEdit frag = new DialogFragmentEmailExportAddressEdit();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        View dialogBody =  getActivity().getLayoutInflater().inflate(R.layout.dialog_fragment_email_export_address_edit, null);
        emailAddressText = (EditText) dialogBody.findViewById(R.id.email_export_address_field);
        emailAddressText.setText(getArguments().getString("currentAddress"));
    ...
    private View.OnClickListener onPositiveClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            ((SettingsActivity)getActivity()).updateEmailExportAddress(emailAddressText.getText().toString());
            dismiss();
